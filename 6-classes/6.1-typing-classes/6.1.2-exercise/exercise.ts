...
class Student extends Person {
  ...
  constructor(firstName: string, lastName: string, age: number, studentId: number, courses: string[]) {
...
const student = new Student('이름', '성', 31, 152530, [ 'HTML', 'CSS', 'JavaScript' ])
console.log(student.fullName()) // '이름성'
student.enroll('TypeScript')
console.log(...student.courses) // [ 'HTML', 'CSS', 'JavaScript', 'TypeScript' ]